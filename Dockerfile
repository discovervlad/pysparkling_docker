...
# Miniconda
ENV MINICONDA_FILE=Miniconda3-4.5.11-Linux-x86_64.sh
RUN \
...
# H2O
ENV H2O_BRANCH_NAME=master
ENV H2O_BUILD_NUMBER=4430
ENV H2O_PROJECT_VERSION=3.21.0.${H2O_BUILD_NUMBER}
...
#ENV PYSPARK_DRIVER_PYTHON="ipython" ${SPARKLING_WATER_HOME}/bin/pysparkling
ENV PYSPARK_DRIVER_PYTHON=jupyter
ENV PYSPARK_DRIVER_PYTHON_OPTS='notebook --ip="*" --no-browser --allow-root'
